		...
		<div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
			<main className="flex flex-col gap-6 row-start-2 items-center text-center sm:items-start sm:text-left">
				<Image
					...
					priority
				/>
				<h1 className="text-2xl sm:text-3xl font-bold">Welcome to VeoWeb 👋</h1>
				<p className="max-w-xl text-sm sm:text-base text-gray-600 dark:text-gray-400">
					VeoWeb is a web-based GUI for managing customizable tables and menus.
					Create schemas, add data, and visualize everything in one place — no
					code required.
				</p>
